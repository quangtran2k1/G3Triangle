...
public class HibernateConfig {
	...
	public DataSource getDataSource() {
		...
		dataSource.setUrl(env.getProperty("db.url")+"encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1.2");
	...
	public SessionFactory getSessionFactory(DataSource dataSource) throws IOException {
		...
		factoryBean.setPackagesToScan(new String[] {"com.g3triangle.shopthoitrang.entity"});
